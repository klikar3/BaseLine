...
class PerfCounterPerServerController extends Controller
{
    ...
    public function actionUpdate($id)
    {
        ...
        switch ($model->belongsto) {
            case 'cpu': $ziel = 'server-view/res_cpu'; break;
            case 'disk': $ziel = 'server-view/res_disk'; break;
            case 'mem': $ziel = 'server-view/res_mem'; break;
            case 'net': $ziel = 'server-view/res_net'; break;
            case 'sess': $ziel = 'server-view/res_sess'; break;
        }

        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect([$ziel, 'id' => $model->server_id]);
        } else {
