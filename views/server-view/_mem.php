...
<div class="row">
  ...
  <?php  echo app\controllers\ServerViewController::getPaintLine($servername, $dataset_13, $cntrs[13], $id, 0, "BufMangr: Page Reads/Sec"); ?>
  <?php  echo app\controllers\ServerViewController::getPaintLine($servername, $dataset_14, $cntrs[14], $id, 0, "BufMangr: Page Writes/Sec"); ?>
  <?php  echo app\controllers\ServerViewController::getPaintLine($servername, $dataset_7, $cntrs[7], $id, 0,"SQL: Log Bytes Flushed/Sec"); ?>
  <?php  echo app\controllers\ServerViewController::getPaintLine($servername, $dataset_8, $cntrs[8], $id, 0,"SQL: Log Flushes/sec"); ?>
  <?php  echo app\controllers\ServerViewController::getPaintLine($servername, $dataset_9, $cntrs[9], $id, 0,"SQL: SQL Compilations/Sec"); ?>
